...
class TronClient extends JFrame implements ActionListener, KeyListener, MouseListener {
    ...
    private JTextField gamesText = new JTextField(15);
    ...
    public class GameMenu extends JPanel implements ActionListener {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (t < 10) {
                g.drawImage(tron1, 0, 0, width, height, this);
            } else if (t < 20) {
                g.drawImage(tron2, 0, 0, width, height, this);
            } else {
                t = 0;
            }
